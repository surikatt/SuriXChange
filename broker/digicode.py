...
def digicode(desarmage):
    global tentative_en_cours, derniere_touche, boutons_appuyes, sup_histo
    while True:
        ...
        for y in valeur_verticale:
            ...
            for x in valeur_horizontale:
                if GPIO.input(x) == 1:
                    presse = bouton[valeur_horizontale.index(
                        x)][valeur_verticale.index(y)]
